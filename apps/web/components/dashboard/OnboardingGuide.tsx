  ...
  const steps = [
    {
      ...
      description: "You're now ready to automate your screenshot management. Let's get you set up in just a few minutes.",
      action: {
        label: "Get Started",
    ...
    },
    {
      ...
      description: "A project contains all the screenshots for one website or application. You can configure multiple URLs, selectors, and automation rules.",
      action: {
    ...
    },
    {
      ...
      description: "After creating a project, add screenshot configurations. Specify URLs, CSS selectors, viewports, and scheduling options.",
      action: {
        label: "Got it!",
    ...
    },
    {
      ...
      description: "Connect GitHub, Slack, or email notifications to automatically update your documentation when changes are detected.",
      action: {

      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          <p className="mt-6 text-xl text-blue-100 max-w-3xl mx-auto">
            Join thousands of teams who have transformed their documentation workflow. 
            Start your free trial today and experience the difference automated screenshot management can make.
          </p>

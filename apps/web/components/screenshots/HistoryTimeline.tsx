      ...
      <div className="space-y-8">
        {entries.map((entry, index) => (
          <div key={entry.id} className="relative flex items-start space-x-4">
            {/* Timeline dot */}
            <div className="relative z-10 flex-shrink-0">{getStatusIcon(entry.status)}</div>
              ...
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  ...
                  <div className="flex items-center space-x-4 text-xs text-gray-500">
                    <span>
                      {formatDistanceToNow(new Date(entry.capturedAt), { addSuffix: true })}
                    </span>
                    <span>
                    ...
                    {entry.metadata.duration > 0 && (
                      <span>{(entry.metadata.duration / 1000).toFixed(1)}s</span>
                    )}
                  </div>
              ...
              <div className="flex items-center justify-between mt-4 pt-4 border-t border-gray-100">
                <div className="flex items-center space-x-2">
                  ...
                  {entry.changeDetected && entry.diffUrl && (
                    <Button onClick={() => onDiffView(entry)} variant="outline" className="text-sm">
                      View Diff
                    </Button>
                  )}
                </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center space-x-4">
                ...
                <div className="flex space-x-2">
                  ...
                  {entry.changeDetected && (
                    <Button onClick={() => onDiffView(entry)} variant="outline" className="text-xs">
                      Diff
                    </Button>
                  )}
                </div>

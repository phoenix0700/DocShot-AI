        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
              Automatically capture screenshots, detect visual changes, and update your
              documentation across GitHub, Notion, and more—all with a simple YAML configuration.
            </p>
    ...
    autoCommit: true`}</pre>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-lg p-6 shadow-md">
              ...
              <p className="text-gray-600">
                Capture full pages, specific elements, or custom viewports. Handle authentication,
                cookies, and dynamic content with ease.
              </p>
            </div>
            ...
            <div className="bg-white rounded-lg p-6 shadow-md">
              ...
              <p className="text-gray-600">
                Automatically detect visual changes and get notified. Review differences with our
                intuitive diff viewer before approving updates.
              </p>
            </div>
            ...
            <div className="bg-white rounded-lg p-6 shadow-md">
              ...
              <p className="text-gray-600">
                Push screenshots directly to GitHub, update Notion pages, send Slack notifications,
                and integrate with your existing workflow.
              </p>
            </div>
            ...
            <div className="bg-white rounded-lg p-6 shadow-md">
              ...
              <p className="text-gray-600">
                Set up cron schedules for automatic captures. Keep your documentation fresh without
                lifting a finger.
              </p>
            </div>
            ...
            <div className="bg-white rounded-lg p-6 shadow-md">
              ...
              <p className="text-gray-600">
                Configure everything with a simple YAML file. Version control your screenshot
                configurations alongside your code.
              </p>
            </div>
            ...
            <div className="bg-white rounded-lg p-6 shadow-md">
              ...
              <p className="text-gray-600">
                Get notified only when it matters. Email alerts for visual changes, failures, and
                approved updates.
              </p>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">Sign up and create your first project in seconds.</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">Define what to capture using our simple YAML format.</p>
            </div>
      ...
      <section className="py-20 bg-blue-600">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="mt-4 text-blue-100">No credit card required • Setup in 5 minutes</p>
        </div>
      </section>

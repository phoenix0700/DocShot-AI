...
async function testScreenshot() {
  ...
  try {
    ...
    console.log(`   Viewport: ${result1.metadata.viewport.width}x${result1.metadata.viewport.height}\n`);
    ...
    try {
      ...
      console.log(`⚠️  Storage test skipped (not configured):`, storageError instanceof Error ? storageError.message : 'Unknown error');
    }
